...
输出：`wood.jpg`。参考：interior-03.jpg、interior-10.jpg
...
输出：`floor.jpg`。参考：interior-03.jpg、interior-07.jpg
...
输出：`countertop.jpg`。参考：interior-03.jpg
...
输出：`green.jpg`。参考：interior-03.jpg
...
输出：`vanity.jpg`。参考：interior-07.jpg
...
网页发布文件经过 JPEG 编码压缩；不改变构图或纹理内容。原始生成 PNG 保存在本机 generated_images 目录。
